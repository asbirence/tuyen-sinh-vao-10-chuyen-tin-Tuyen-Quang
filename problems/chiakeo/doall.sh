...
scripts/gen-input-via-stdout.sh "wine files/gen.exe '--type=1' '41'" "tests/41" 41
echo "Generating test #42"
scripts/gen-input-via-stdout.sh "wine files/gen.exe '--type=1' '42'" "tests/42" 42
echo "Generating test #43"
scripts/gen-input-via-stdout.sh "wine files/gen.exe '--type=1' '43'" "tests/43" 43
echo "Generating test #44"
scripts/gen-input-via-stdout.sh "wine files/gen.exe '--type=1' '44'" "tests/44" 44
echo "Generating test #45"
scripts/gen-input-via-stdout.sh "wine files/gen.exe '--type=1' '45'" "tests/45" 45
...
scripts/gen-input-via-stdout.sh "wine files/gen.exe '--type=2' '48'" "tests/48" 48
